    ...
    if season_dir.startswith("season_"):
        ...
        if os.path.isdir(season_path):
            ...
            if os.path.exists(csv_path):
                ...
                # Add a 'season' column
                season_number = season_dir.replace("season_s-", "")
...
merged_df.to_csv("all_seasons_team_stats.csv", index=False)

print("Merged CSV file created: all_seasons_team_stats.csv")
